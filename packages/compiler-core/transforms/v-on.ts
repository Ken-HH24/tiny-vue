...
import { TO_HANDLER_KEY } from '../runtime-helpers'
import type { DirectiveTransform, DirectiveTransformResult } from '../transform'
import { isMemberExpression } from '../utils'
import { processExpression } from './transform-expression'
...
export const vOnTransform: DirectiveTransform = (dir, _node, context) => {
